...
colors:
  primary: "#10b981"            # Hijau Emerald cerah dan modern (Energi/Nature)
  primary-focus: "#059669"      # Hijau lebih gelap untuk efek hover/aktif
  primary-on-dark: "#34d399"    # Hijau neon/terang yang kontras untuk Dark Mode
  ink: "#131f1c"                # Abu-abu sangat gelap dengan rona hijau (pengganti hitam pekat)
  body: "#131f1c"               # Sama dengan ink, nyaman untuk dibaca
  body-on-dark: "#ffffff"       # Putih bersih untuk teks di background gelap
  body-muted: "#b2c0b9"         # Teks sekunder dengan rona sage-gray
  ink-muted-80: "#2a3f37"       # Abu-abu gelap kehijauan
  ink-muted-48: "#6c8278"       # Abu-abu medium kehijauan
  divider-soft: "#e6f0eb"       # Garis pemisah yang sangat lembut (hint mint)
  hairline: "#d3e0d8"           # Garis border (border-color)
  canvas: "#ffffff"             # Putih bersih untuk background utama
  canvas-parchment: "#f3f8f5"   # Off-white dengan nuansa hijau sage yang sangat tipis
  surface-pearl: "#f7fbf8"      # Off-white terang, cocok untuk card/bento box
  surface-tile-1: "#1b2621"     # Dark mode card 1 (Deep forest gray)
  surface-tile-2: "#1f2b25"     # Dark mode card 2 (Sedikit lebih terang)
  surface-tile-3: "#18221d"     # Dark mode card 3 (Lebih gelap)
  surface-black: "#0b120f"      # Background utama Dark Mode (Bukan hitam murni #000, tapi Dark Forest)
  surface-chip-translucent: "#c1d1c8" # Untuk badge/chip dengan transparansi
  on-primary: "#ffffff"         # Teks di atas warna primary (tombol hijau)
  on-dark: "#ffffff"            # Teks di atas elemen gelap

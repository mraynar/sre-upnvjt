CREATE TABLE "attendanceSession" (
	...
	"startTime" timestamp,
	"endTime" timestamp,
	"isForAllRoles" boolean DEFAULT false NOT NULL,
	"targetRoleIds" jsonb DEFAULT '[]'::jsonb NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "attendance" ADD COLUMN "sessionId" integer NOT NULL;--> statement-breakpoint
...
ALTER TABLE "attendance" DROP COLUMN "date";--> statement-breakpoint

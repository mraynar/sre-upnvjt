...
import { 
  ArrowUpRight, BookOpen, Cpu, Leaf, Users, Mail, ChevronRight, MapPin
} from "lucide-react";
...
export default function AboutClient({ divisionsData }) {
  ...
  return (
    <div className="min-h-screen bg-[#07130e] text-white selection:bg-[#e8ecc4] selection:text-[#07130e] antialiased">
      
      {/* 1. Hero Section */}
      <section className="relative pt-44 pb-24 px-6 md:px-12 lg:px-20 overflow-hidden border-b border-white/5">
      ...
      <section className="py-28 px-6 md:px-12 lg:px-20 bg-[#050e0a] border-b border-white/5 relative">
      ...
      <section className="py-28 px-6 md:px-12 lg:px-20 border-b border-white/5">
            ...
            {structures.map((st, idx) => (
              ...
              >
                <div className="flex justify-between items-start mb-6">
                  ...
                  <span className="text-[10px] font-mono tracking-widest text-[#e8ecc4] uppercase font-bold px-2 py-0.5 rounded bg-white/5">{st.subtitle}</span>
                </div>
      ...
      {divisionsData.length > 0 && (
        <section className="py-28 px-6 md:px-12 lg:px-20 bg-[#050e0a] border-b border-white/5">
          <div className="max-w-7xl mx-auto flex flex-col items-center">
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-28 px-6 md:px-12 lg:px-20 text-center relative overflow-hidden">
